...
/**
 * Annotation used on methods or fields to warn the developer that it is bound to an external value and should be used
 * carefully, especially for setter / writing values, as it is most likely only meant to be modified in a specific
 * flow.
 */
