...
/**
 * Represents the status of a {@link SelectionEntity}, indicating whether it is open for voting or has been closed,
...
public enum SelectionStatus {
    ...
    /**
     * The {@link SelectionEntity} has been manually closed by an {@link UserEntity} with application administrator
     * privileges.
     */
    CLOSED(true),

    /**
     * The {@link SelectionEntity} has been automatically closed because the number of {@link AnimeEntity} entries is
     * less than or equal to the number of votes required, rendering the voting process unnecessary.
     */
    AUTO_CLOSED(true);
